...
(function () {
  ...
  const dict = {
    en: {
      ...
      showHide: 'Show / hide',
      canvas: 'Canvas',
      canvasHelp: 'While editing a node, Tab saves and adds a child; ⌘↩ saves and adds a sibling. The same ⌘↩ chord also adds a sibling when a node is only selected.',
    ...
    zh: {
      ...
      showHide: '显示 / 隐藏',
      canvas: '画布',
      canvasHelp: '编辑节点时，Tab 保存并添加子节点，⌘↩ 保存并添加同级。只选中节点、没有在编辑时，同一个 ⌘↩ 也会添加同级。',
      scGroupGeneral: '通用',
      scGroupBuild: '搭建',
      scGroupNav: '导航',
      scGroupHistory: '历史',
