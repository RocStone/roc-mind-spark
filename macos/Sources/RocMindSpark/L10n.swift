...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "shortcut.addSiblingMod": "Add sibling (⌘↩)",
        "shortcut.editNode": "Edit node",
        "shortcut.deleteNode": "Delete node",
        "shortcut.deleteForward": "Delete node (forward)",
        "shortcut.collapse": "Collapse / expand",
        "shortcut.link": "Cross-link",
        "shortcut.moveSiblingUp": "Move sibling up",
        "shortcut.moveSiblingDown": "Move sibling down",
        "shortcut.moveSiblingUpAlt": "Move sibling up (alternate)",
        "shortcut.moveSiblingDownAlt": "Move sibling down (alternate)",
        "shortcut.undo": "Undo",
        "shortcut.redo": "Redo",
        "shortcut.find": "Find",
        "shortcut.findReplace": "Find and replace",
    ...
    private static let zh: [String: String] = [
        ...
        "shortcut.addSiblingMod": "添加同级节点（⌘↩）",
        "shortcut.editNode": "编辑节点",
        "shortcut.deleteNode": "删除节点",
        "shortcut.deleteForward": "删除节点（向前删除）",
        "shortcut.collapse": "折叠 / 展开",
        "shortcut.link": "交叉连接",
        "shortcut.moveSiblingUp": "上移同级节点",
        "shortcut.moveSiblingDown": "下移同级节点",
        "shortcut.moveSiblingUpAlt": "上移同级节点（备用）",
        "shortcut.moveSiblingDownAlt": "下移同级节点（备用）",
        "shortcut.undo": "撤销",
        "shortcut.redo": "重做",
        "shortcut.find": "查找",
        "shortcut.findReplace": "查找并替换",
        "shortcut.help": "快捷键列表",
        "menu.edit": "编辑",
        "menu.undo": "撤销",
        "menu.redo": "重做",
