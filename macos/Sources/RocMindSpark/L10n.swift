...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "settings.overlay.help": "Default is ⌥⇧⌘Q. It is a busy chord on purpose — change it here if you want something simpler.",
    ...
    private static let zh: [String: String] = [
        ...
        "settings.overlay": "浮层",
        "settings.overlay.help": "默认 ⌥⇧⌘Q。和弦比较满，可在这里改成更好按的组合。",
        "settings.canvas": "画布",
        "settings.reset": "恢复默认",
